...
from backend.app.memory.models import Fact, FactCandidate, MemoryStatus, Provenance
...
class TemporalResolver:
    ...
    def resolve_facts_for_query(
        ...
        competing = [
            ...
            if sc[0] >= top_score - 1.0 and sc[3] != top_bound_ans and sc[1].predicate == top_cand.predicate
        ]
        ...
        all_same_predicate = [sc for sc in scored_candidates if sc[1].predicate == top_cand.predicate]
